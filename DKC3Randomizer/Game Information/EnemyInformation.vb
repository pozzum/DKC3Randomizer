Public Class EnemyInformation
    Public Class EnemyClass
        ...
        Public Aquaphobic As Boolean = False 'Squitter  can't be in levels with water because of crashes
    ...
    Public Sub Initialize(AllowBosses As Boolean, AllowFriends As Boolean, Optional KoinPlaceable As Boolean = False)
...
#Region "Friendlies"
        If AllowFriends Then
            ...
            FullEnemyList.Add(New EnemyClass() With {
                    .Name = "Squawks",
                    .IDNum = New List(Of Int32)(New Int32() {&H4}),
                    .Friendly = True,
                    .Floats = True,
                    .JumpKillable = False,
                    .SpinKillable = False,
...
#End Region
#Region "Koin Option"
        If KoinPlaceable Then
            FullEnemyList.Add(New EnemyClass() With {
                    .Name = "Koin (DK)",
                    .IDNum = New List(Of Int32)(New Int32() {&H5A4}),
                    .Friendly = False,
                    .Floats = False,
                    .JumpKillable = False,
                    .SpinKillable = False,
